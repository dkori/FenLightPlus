I'm jokingly called this FenLight+. There was always 1 thing I wished Fen could do that it couldn't and that was delete RD Cloud files from the results screen so that I didn't have to go into My Services everytime I accidentally added a bad package to the cloud. Now it can. 
...
Since then I've also added more features, such as:
 ...
 - TMDB Lists integration and ability to export Trakt lists to TMDB
...
This is the first Kodi addon I've ever edited so Tikipeter would probably shed a tear at how I butchered his code.
